...
A number is called a smart number if it has an odd number of factors. Given some numbers, find whether they are
smart numbers or not.
...
lines. In the line print YES if the

integer has an odd number of factors, else print NO.
...
The answer is NO. The factors of 7 are 1 and 7.It has even number of factors.The answer is NO.
