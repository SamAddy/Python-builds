...
def add(a, b):
    return numpy.add(a, b, dtype=numpy.int_)


def subtract(a, b):
    return numpy.subtract(a, b, dtype=numpy.int_)


def multiply(a, b):
    return numpy.multiply(a, b, dtype=numpy.int_)
...
def mod(a, b):
    return numpy.mod(a, b, dtype=numpy.int_)


def power(a, b):
    return numpy.power(a, b, dtype=numpy.int_)
